...
(prelude-require-packages
 '(cider ag ample-theme
         clojure-cheatsheet clojure-mode clojure-test-mode
...
(eval-after-load 'fsharp-mode
  '(progn
     (define-key fsharp-mode-map (kbd "C-c C-e") 'fsharp-eval-region)
